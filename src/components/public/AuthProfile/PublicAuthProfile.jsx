...
import PublicProfileInfo from "./PublicProfileInfo/PublicProfileInfo";
import PublicPostInfo from "./PublicPostInfo/PublicPostInfo";
import PublicExploreInfo from "./PublicExploreInfo/ExploreInfo";
...
const PublicAuthProfile = () => {
    ...
    const extractedUsername = pathname.slice(1);
    console.log(extractedUsername);

    const [username, setUsername] = useState(extractedUsername);
    ...
    const searchUsers = {
        ...
        userReview: [
            ...
            },
            {
                ...
                rating: 4,
                reviewText:
                    "Had a great experience with Rina. Very professional.",
    ...
    useEffect(() => {
        ...
        if (extractedUsername === authUser.username) {
            navigate("/profile");
        }
    }, [extractedUsername, navigate]);
        ...
        <main className="h-full w-full max-w-[1400px] m-auto">
            <section className="w-full h-full flex flex-col lg:flex-row justify-around items-start p-2 gap-5">
                ...
                <div className=" w-full lg:w-4/12 p-3 border">
                    ...
                    <PublicProfileInfo user={searchUsers} />
                </div>
                ...
                <div className=" p-3 w-full lg:w-8/12">
                    <PublicPostInfo user={searchUsers} />
                </div>
...
export default PublicAuthProfile;
